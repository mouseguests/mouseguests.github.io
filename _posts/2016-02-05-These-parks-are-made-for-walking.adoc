...
I had big plans of posting a trip report from our December stay at Beach Club, but have since decided that such an article would be extremely long and could be summarized simply with "It was a lot of fun!". So instead of giving a play by play on everything we did and everything we ate, I thought it'd be informative to share how much we walked.
